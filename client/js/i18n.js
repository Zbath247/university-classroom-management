...
(function (window) {
  ...
  const TRANSLATIONS = {
    km: {
      ...
      'table.resource_title': 'ចំណងជើង',
      'table.resource_type': 'ប្រភេទឯកសារ',
      'table.link_url': 'តំណភ្ជាប់ URL',
      'table.description_notes': 'ការពិពណ៌នា',
      ...
      'upload.choose_file': 'ឯកសារភ្ជាប់ (File)',
      'upload.drag_drop': 'ចុច ឬទម្លាក់ឯកសារមកទីនេះ',
      'upload.drag_drop_short': 'ឬទម្លាក់ File មកទីនេះ',
      'upload.click_or_drag': 'ចុច ឬទម្លាក់ File មកទីនេះ',
      'upload.file_ready': 'ឯកសាររួចរាល់',
      'upload.selected_file': 'ឯកសារ:',
      'upload.or_enter_url': 'ឬតំណភ្ជាប់ (URL / Link):',
      'upload.file_size_max': 'អតិបរមា 50MB',
    ...
    en: {
      ...
      'upload.choose_file': 'Upload File',
      'upload.drag_drop': 'Click or drop files here',
      'upload.drag_drop_short': 'or drop file here',
      'upload.click_or_drag': 'Click or drop file here',
      'upload.file_ready': 'File ready',
      'upload.selected_file': 'Selected file:',
      'upload.or_enter_url': 'Or URL Link:',
      'upload.file_size_max': 'Max: 50MB',
